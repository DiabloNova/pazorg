      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="bg-card p-8 rounded-xl border text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="text-4xl font-bold text-secondary mb-2 animate-pulse">2-4 ساعت</div>
            ...
            <div className="flex items-start gap-6 group">
              ...
              <div className="flex-1">
                ...
                <p className={`text-muted-foreground ${language === "fa" ? "font-vazirmatn" : ""}`}>
                  انتقال مستقیم بانک به بانک با رعایت کامل قوانین و مستندسازی
                </p>
              </div>
            </div>
            <div className="flex items-start gap-6 group">
              ...
              <div className="flex-1">
                ...
                <p className={`text-muted-foreground ${language === "fa" ? "font-vazirmatn" : ""}`}>
                  راه‌حل‌های دیجیتال مدرن برای پردازش سریع‌تر و کارمزد کمتر
                </p>
              </div>
            </div>
            <div className="flex items-start gap-6 group">
              ...
              <div className="flex-1">
                ...
                <p className={`text-muted-foreground ${language === "fa" ? "font-vazirmatn" : ""}`}>
                  انتقال‌های عمده و سیستم‌های پرداخت خودکار برای کسب‌وکارها
                </p>
              </div>
            </div>
          </div>
